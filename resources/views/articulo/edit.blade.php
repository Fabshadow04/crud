@extends('layouts.plantillabase') //se extiende plantilla base 

@section('contenido')
<h2>EDITAR REGISTROS</h2>

<form action="/articulos/{{$articulo->id}}" method="POST"> //se redirige a articulos y despues se toma el id 
    @csrf    
    @method('PUT')
  <div class="mb-3">
    <label for="" class="form-label">Código</label>
    <input id="codigo" name="codigo" type="text" class="form-control" value="{{$articulo->codigo}}">    
  </div>                                                                     //trae el valor de la bd
  <div class="mb-3">
